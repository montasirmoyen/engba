...
static constexpr uint32_t S[] = { 7, 12, 17, 22, 7, 12, 17, 22, 7, 12, 17, 22, 7, 12, 17, 22,
 ...
 */
static constexpr uint8_t PADDING[] = { 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
void md5Update(struct MD5Context* ctx, const void* input, size_t len) {
	...
	const uint8_t* inputBuffer = static_cast<const uint8_t*>(input);
	ctx->size += len;
