...
static THREAD_ENTRY _promptThread(void* context) {
	struct CLIDebuggerEditLineBackend* elbe = static_cast<struct CLIDebuggerEditLineBackend*>(context);
...
struct CLIDebuggerBackend* CLIDebuggerEditLineBackendCreate(void) {
	struct CLIDebuggerEditLineBackend* elbe = static_cast<struct CLIDebuggerEditLineBackend*>(calloc(1, sizeof(*elbe)));
