...
static void GBATimerUpdate(struct GBA* gba, int timerId, uint32_t cyclesLate) {
	...
	if (GBATimerFlagsIsDoIrq(timer->flags)) {
		GBARaiseIRQ(gba, static_cast<enum GBAIRQ>(GBA_IRQ_TIMER0 + timerId), cyclesLate);
	}
